...
export const GetDashboardActividadResponse = zod.array(
  GetDashboardActividadResponseItem,
);
...
export const ListNotificacionesResponse = zod.array(
  ListNotificacionesResponseItem,
);
