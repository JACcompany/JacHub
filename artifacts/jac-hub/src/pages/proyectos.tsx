...
import { Loader2, Plus, Calendar, Users, Cpu, Trash2, Kanban } from "lucide-react";
      ...
      <div className="space-y-6">
            ...
            <DialogContent className="sm:max-w-[425px] border-primary/20 bg-card">
              <form onSubmit={handleCreate}>
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Inicializa un nuevo entorno de desarrollo.
                  </DialogDescription>
                </DialogHeader>
                <div className="grid gap-4 py-4">
                  ...
                  <div className="grid gap-2">
                    ...
                    <Select 
                      ...
                      onValueChange={(val) => setNuevoProyecto({...nuevoProyecto, estado: val})}
                    >
                      <SelectTrigger>
        ...
        {isLoading ? (
              ...
              <Card key={proyecto.id} className="border-border hover:border-primary/50 transition-all duration-300 group flex flex-col relative overflow-hidden">
                ...
                <CardHeader className="pb-3 relative z-10">
                  <div className="flex justify-between items-start">
                    ...
                    <Badge variant="outline" className={getEstadoColor(proyecto.estado)}>
                      {proyecto.estado}
                    </Badge>
                  </div>
                    ...
                    <AlertDialogContent className="border-destructive/20 bg-card">
                      <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                          Esta acción eliminará el proyecto "{proyecto.nombre}" y todos los datos asociados. Esta acción no se puede deshacer.
                        </AlertDialogDescription>
                      </AlertDialogHeader>
                      <AlertDialogFooter>
          ...
          <div className="text-center py-20 border border-dashed border-border rounded-lg bg-card/20">
            ...
            <h3 className="text-lg font-medium text-foreground">Sistema Vacío</h3>
            <p className="text-muted-foreground mt-2 max-w-sm mx-auto">No hay proyectos activos en la base de datos. Inicializa un nuevo proyecto para comenzar.</p>
